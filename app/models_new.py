...
class Manager(UserMixin, db.Model):
    ...
    def __init__(self, ManagerNum, ManagerName, ManagerSex,  ManagerPermission):
        self.ManagerNum = ManagerNum
        self.ManagerName = ManagerName
        self.ManagerSex = ManagerSex

        self.ManagerPermission = ManagerPermission
...
class Picture(db.Model):
    #图片信息
    PictureName = db.Column(db.String(100), primary_key=True,nullable=False)
    PictureType = db.Column(db.String(10), nullable=False)
    RenderTime =db.Column(db.String(100), nullable =False)
    PicturePath =db.Column(db.String(100), nullable =False)

    def __init__(self,  PictureName, PictureType, RenderTime, PicturePath):
